...
OPENAI_ROOT_DIR = f"{EUREKA_ROOT_DIR}/../openaigymenvs"
...
def main(cfg):
    ...
    output_file = f"{OPENAI_ROOT_DIR}/tasks/{env_name}{suffix.lower()}.py"
    ...
    create_task(OPENAI_ROOT_DIR, cfg.env.task, cfg.env.env_name, suffix)
    ...
    for iter in range(cfg.iteration):
        ...
        for response_id in range(cfg.sample):
            ...
            # TODO: Swap out train.py
            rl_filepath = f"env_iter{iter}_response{response_id}.txt"
            with open(rl_filepath, 'w') as f:
                process = subprocess.Popen(['python', '-u', f'{OPENAI_ROOT_DIR}/train.py',  
        ...
        for response_id, (code_run, rl_run) in enumerate(zip(code_runs, rl_runs)):
            ...
            content = ''
            traceback_msg = filter_traceback(stdout_str) # Filter out the traceback error message
